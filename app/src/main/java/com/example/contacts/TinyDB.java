...
public class TinyDB {
    ...
    public ArrayList<ModelContact> getListObject(String key, Class<?> mClass){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<ModelContact> objects =  new ArrayList<ModelContact>();

    	for(String jObjString : objStrings){
    		Object value  = gson.fromJson(jObjString,  mClass);
    		objects.add((ModelContact) value);
    	}
    	return objects;
    }
    ...
    public void putListObject(String key, ArrayList<ModelContact> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
